...
TEST_CASE("to_upper/to_lower", "[text]")
{
    ...
    std::array const data = {
        d_p{'a', 'A'}, d_p{'b', 'B'}, d_p{'c', 'C'}, d_p{'d', 'D'}, d_p{'e', 'E'}, d_p{'f', 'F'},
        d_p{'g', 'G'}, d_p{'h', 'H'}, d_p{'i', 'I'}, d_p{'j', 'J'}, d_p{'k', 'K'}, d_p{'l', 'L'},
        d_p{'m', 'M'}, d_p{'n', 'N'}, d_p{'o', 'O'}, d_p{'p', 'P'}, d_p{'q', 'Q'}, d_p{'r', 'R'},
        d_p{'s', 'S'}, d_p{'t', 'T'}, d_p{'u', 'U'}, d_p{'v', 'V'}, d_p{'w', 'W'}, d_p{'x', 'X'},
        d_p{'y', 'Y'}, d_p{'z', 'Z'}, d_p{'(', '('}, d_p{')', ')'}, d_p{'[', '['}, d_p{']', ']'},
        d_p{'}', '}'}, d_p{'{', '{'}, d_p{';', ';'}, d_p{':', ':'}, d_p{'/', '/'}, d_p{'+', '+'},
        d_p{'-', '-'}, d_p{'*', '*'}, d_p{'=', '='}, d_p{'&', '&'},
    };
